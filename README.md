...
![Tests](https://img.shields.io/badge/tests-763%20Vitest%20%2B%2032%20Node-brightgreen)
...
- Vitest 单元测试（126 个测试文件 / 763 个测试；另有 Electron 与发布边界 Node 测试）
...
```bash
npm test            # 763 Vitest tests + 32 Node tests
npm run typecheck
npm run build
```
